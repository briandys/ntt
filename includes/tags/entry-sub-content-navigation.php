...
if ( ! function_exists('ntt_sub_content_nav' ) ) {
    function ntt_sub_content_nav( $total ) {
        ...
        $l_mu_start = '<span class="entry-sub-content-navi---l l">';
            $l_mu_start .= '<span class="page---txt txt">'. $page_term. '</span>';
            $l_mu_start .= ' '. '<span class="page-number---txt num txt">';
            $l_mu_end = '</span>';
        $l_mu_end .= '</span>';

        $adjacent_navi_mu = '<span class="entry-sub-content-navi---l adjacent-navi---l '. sanitize_title( '%1$s' ).'-adjacent-navi---l l" title="%2$s">';
