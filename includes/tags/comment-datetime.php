                ...
                <div class="comment-published-datetime published-datetime cm-datetime datetime cp" data-name="Comment Published DateTime">
                    <div class="comment-published-datetime---cr cm-datetime---cr">
                        ...
                        <span class="comment-published-datetime-glabel glabel obj" data-name="Comment Published DateTime Generic Label">
                            <span class="commented---txt"><?php echo esc_html_x( 'Commented on', '->Commented on<- [date]', 'ntt' ); ?></span>
                        </span>
                        ...
                        <time datetime="<?php echo get_comment_date( DATE_W3C ); ?>" class="comment-published-date published-date cm-date dt-published date obj" data-name="Comment Published Date">
                            <a href="<?php echo esc_url( $comment_url ); ?>" title="<?php echo esc_attr_x( 'Commented on', '->Commented on<- [date]', 'ntt' ). ' '. esc_attr( $date_title_attr ); ?>" class="comment-published-date---a">
                                <span class="comment-published-date---l"><?php echo $date_mu; ?></span>
                            </a>
                        </time>
                        
                        <span class="comment-published-time published-time cm-time time obj" data-name="Comment Published Time">
                            <a href="<?php echo esc_url( $comment_url ); ?>" title="<?php echo esc_attr_x( 'Commented at', '->Commented at<- [time]', 'ntt' ). ' '. esc_attr( $time_title_attr ); ?>" class="comment-published-time---a">
                                <span class="comment-published-time---l"><?php echo $time_mu; ?></span>
                            </a>
                        </span>
