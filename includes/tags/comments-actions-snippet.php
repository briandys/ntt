        ...
        <div class="ntt--comments-actions-snippet ntt--cp" data-name="Comments Actions Snippet">
            <div class="ntt--comments-count ntt--obj" data-name="Comments Count">
                ...
                $comments_count_mu = '<span class="ntt--txt">';
                    $comments_count_mu .= '<span class="count-txt ntt--num">'. esc_html( '%1$s' ).'</span>';
            ...
            if ( comments_open() ) {
                ...
                if ( ! is_user_logged_in() && get_option( 'comment_registration' ) ) {
                    ...
                    $requirement_mu = ' '. '<span class="requirement-txt">'. esc_html( $requirement_txt ). '</span>';
            ...
            // Disabled Comments
                ...
                $comment_creation_content_mu = '<div class="ntt--disabled-comments-note note ntt--cp" data-name="Disabled Comments Note">';
