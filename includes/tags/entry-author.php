    ...
    function ntt_entry_author() {
        ...
        <div class="ntt--entry-author ntt--cm-author ntt--cp" data-name="Entry Author">
            <label class="ntt--entry-author-label ntt--cm-entry-author-label ntt--obj" data-name="Entry Author Label">
                <span class="ntt--txt"><?php echo apply_filters( 'ntt_entry_author_label_wp_filter', esc_html_x( 'Published by', 'Published by Author', 'ntt' ) ); ?></span>
            </label>
            ...
            if ( get_option( 'show_avatars' ) == 1 ) {
                ...
                <span class="ntt--entry-author-avatar ntt--cm-author-avatar ntt--obj" data-name="Entry Author Avatar">
                    <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo apply_filters( 'ntt_entry_author_label_wp_filter', esc_attr_x( 'Published by', 'Published by Author', 'ntt' ) ). ' '. esc_attr( get_the_author() ); ?>">
                        <span class="ntt--img">
                            <?php
                            echo get_avatar(
            ...
            ?>
            <span title="<?php echo apply_filters( 'ntt_entry_author_label_wp_filter', esc_attr_x( 'Published by', 'Published by Author', 'ntt' ) ). ' '. esc_attr( get_the_author() ); ?>" class="ntt--entry-author-name ntt--cm-author-name ntt--obj">
