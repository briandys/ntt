                    ...
                    <?php if ( get_next_comments_link() ) { ?>
                        ...
                        <div class="next-comments-navi adjacent-navi navi obj" data-name="Next Comments Navi">
                            <?php $next_comments_navi = '<span class="next-comments-navi---l">';
                                $next_comments_navi .= '<span class="next---text">'. esc_html_x( 'Next', 'Component: Next Comments Navi | Usage: >Next< Comments', 'ntt' ).'</span>';
                                $next_comments_navi .= ' '. '<span class="comments---text">'. esc_html_x( 'Comments', 'Component: Next Comments Navi | Usage: Previous >Comments<', 'ntt' ). '</span>';
                    ...
                    if ( get_previous_comments_link() ) {
                        ...
                        <div class="previous-comments-navi adjacent-navi navi obj" data-name="Previous Comments Navi">
                            <?php $prev_comments_navi = '<span class="previous-comments-navi---l">';
                                $prev_comments_navi .= '<span class="previous---text">'. esc_html_x( 'Previous', 'Component: Previous Comments Navi | Usage: >Previous< Comments', 'ntt' ).'</span>';
                                $prev_comments_navi .= ' '. '<span class="comments---text">'. esc_html_x( 'Comments', 'Component: Previous Comments Navi | Usage: Previous >Comments<', 'ntt' ). '</span>';
